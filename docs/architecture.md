...
5. **Windows UI** — self-contained WPF/.NET shell with dark-first setup, animated tray icon, navigation, signal-source chooser, discovery, light-mode toggle, and About page.
...
- Expand guided field descriptions and checked-in KQL templates without limiting the user-controlled query surfaces.
